    ...
    swal
      ...
      `,
        ...
        didOpen: () => {
          ...
          firstNameInput = popup.querySelector(
            "#firstname"
          ) as HTMLInputElement;
      ...
      <Container>
        <Section>
          ...
          <Slide>
            ...
            <UpdateButton
              onClick={() => handleChangeEmail(user._id)}
              title="Change email"
            >
              <HiPencil />
            </UpdateButton>
          ...
          <Slide>
            <Button onClick={() => swapUpdatingForm()}>
              Change my password
            </Button>
            <DeleteButton onClick={() => setDeletingAccount(true)}>
              Delete my account
            </DeleteButton>
          </Slide>
        </Section>
        {isUpdatingPass === true && (
          <Section>
            <Form method="POST" onSubmit={handleChangePassword}>
              ...
              <DeleteButton onClick={() => setIsUpdatingPass(false)}>
                Cancel
              </DeleteButton>
            </Form>
          </Section>
        ...
        {deletingAccount === true && (
          <Section>
            <Form method="POST" onSubmit={handleDeleteAccount}>
              ...
              <Button type="submit">Confirm</Button>
              <DeleteButton onClick={() => setDeletingAccount(false)}>
                Cancel
              </DeleteButton>
            </Form>
          </Section>
